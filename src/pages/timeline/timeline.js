...
export default () => {
  ...
  const createPostElement = (post) => {
    ...
    const template = `
      ...
      <section class="postFooter">
        <section class="votes">
          <button class="upVoteButton" data-id="${
            post.docRef
  ...
  const modalCreateEdit = (isNewPost) =>{
    ...
    <div class="modal-createPost hide">
      ...
      <div class="modal-body">
        ...
        <section class="buttonsCreate"> 
          ...
          ${isNewPost ? `<button class="postButtonsCreate confirmButton sendPost">POST</button>` 
          : `<button class="postButtonsCreate confirmButton sendEditPost">EDIT</button>`}
        </section>
      </div>
    </div>
    `
    ...
    if (confirmButton) {
      return { modal, fade, confirmButton, inputModal };
    } else {
      return { modal, fade, confirmEditButton, inputModal };
    }
  }
  ...
  const { modalDelete, fadeDelete, confirmButton } = createModalDelete();
